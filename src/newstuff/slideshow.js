      ...
      <SlideContainer>
        ...
        >
          ...
          <div className="slide-container">
            <img src={ImgA} alt="1works" className="slide-image" />
          </div>
          <div className="slide-container">
            <img src={ImgB} alt="1works"  className="slide-image" />
          </div>
          <div className="slide-container">
            <img src={ImgC} alt="1works"  className="slide-image" />
          </div>
          <div className="slide-container">
            <img src={ImgD} alt="1works" className="slide-image"  />
          </div>
          <div className="slide-container">
            <img src={ImgE} alt="1works" className="slide-image"  />
          </div>
          <div className="slide-container">
            <img src={ImgF} alt="1works" className="slide-image"  />
          </div>
        </Carousel>
      </SlideContainer>
    );
